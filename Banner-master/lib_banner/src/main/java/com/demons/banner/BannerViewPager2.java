...
import static com.demons.banner.Banner.CENTER;
import static com.demons.banner.Banner.MAX_VALUE;
import static com.demons.banner.BannerUtils.getOriginalPosition;
...
import static com.demons.banner.manager.BannerOptions.DEFAULT_REVEAL_WIDTH;
import static com.demons.banner.transformers.ScaleInTransformer.DEFAULT_MIN_SCALE;
...
public class BannerViewPager2<T> extends RelativeLayout implements LifecycleObserver {
    ...
    public BannerViewPager2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public BannerViewPager2<T> setAdapter(BaseBannerAdapter<T> adapter) {
     ...
     */
    public BannerViewPager2<T> setRoundCorner(int radius) {
     ...
     */
    public BannerViewPager2<T> setRoundCorner(int topLeftRadius, int topRightRadius,
     ...
     */
    public BannerViewPager2<T> setAutoPlay(boolean autoPlay) {
     ...
     */
    public BannerViewPager2<T> setCanLoop(boolean canLoop) {
     ...
     */
    public BannerViewPager2<T> setInterval(int interval) {
     ...
     */
    public BannerViewPager2<T> setPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
        if (transformer != null) {
     ...
     * @param transformer PageTransformer that will modify each page's animation properties
     */
    public BannerViewPager2<T> addPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
        if (transformer != null) {
     ...
     */
    public BannerViewPager2<T> setPageMargin(int pageMargin) {
     ...
     */
    public BannerViewPager2<T> setOnPageClickListener(OnPageClickListener onPageClickListener) {
     ...
     */
    public BannerViewPager2<T> setScrollDuration(int scrollDuration) {
     ...
     */
    public BannerViewPager2<T> setIndicatorSliderColor(@ColorInt int normalColor,
     ...
     */
    public BannerViewPager2<T> setIndicatorSliderRadius(int normalRadius, int checkedRadius) {
        mBannerManager.getBannerOptions().setIndicatorSliderWidth(normalRadius * 2, checkedRadius * 2);
        return this;
    }

    public BannerViewPager2<T> setIndicatorSliderWidth(int indicatorWidth) {
    ...
    public BannerViewPager2<T> setIndicatorHeight(int indicatorHeight) {
     ...
     */
    public BannerViewPager2<T> setIndicatorSliderGap(int indicatorGap) {
     ...
     */
    public BannerViewPager2<T> setIndicatorVisibility(@Visibility int visibility) {
        mBannerManager.getBannerOptions().setIndicatorVisibility(visibility);
        return this;
    }

    public BannerViewPager2<T> setIndicatorGravity(@AIndicatorGravity int gravity) {
     ...
     */
    public BannerViewPager2<T> setIndicatorView(IIndicator customIndicator) {
     ...
     */
    public BannerViewPager2<T> setOrientation(@ViewPager2.Orientation int orientation) {
     ...
     */
    public BannerViewPager2<T> setPageStyle(@APageStyle int pageStyle) {
        return setPageStyle(pageStyle, DEFAULT_MIN_SCALE);
    }

    public BannerViewPager2<T> setPageStyle(@APageStyle int pageStyle, float pageScale) {
     ...
     *                    sides
     */
    public BannerViewPager2<T> setRevealWidth(int revealWidth) {
     ...
     */
    public BannerViewPager2<T> setRevealWidth(int leftRevealWidth, int rightRevealWidth) {
     ...
     */
    public BannerViewPager2<T> setOffScreenPageLimit(int offScreenPageLimit) {
        mBannerManager.getBannerOptions().setOffScreenPageLimit(offScreenPageLimit);
        return this;
    }

    public BannerViewPager2<T> setIndicatorMargin(int left, int top, int right, int bottom) {
     ...
     */
    public BannerViewPager2<T> setUserInputEnabled(boolean userInputEnabled) {
    ...
    public BannerViewPager2<T> registerOnPageChangeCallback(
            ViewPager2.OnPageChangeCallback onPageChangeCallback) {
        this.onPageChangeCallback = onPageChangeCallback;
        return this;
    }

    public BannerViewPager2<T> setLifecycleRegistry(Lifecycle lifecycleRegistry) {
    ...
    public BannerViewPager2<T> disallowParentInterceptDownEvent(
     ...
     */
    public BannerViewPager2<T> setRTLMode(boolean rtlMode) {
     ...
     */
    public BannerViewPager2<T> stopLoopWhenDetachedFromWindow(boolean stopLoopWhenDetachedFromWindow) {
        mBannerManager.getBannerOptions()
     ...
     */
    public BannerViewPager2<T> showIndicatorWhenOnItem(boolean showIndicatorWhenOneItem) {
        mBannerManager.getBannerOptions()
    ...
    /**
     * @deprecated Use {@link BannerViewPager2#disallowParentInterceptDownEvent(boolean)} instead.
     */
    @Deprecated
    public BannerViewPager2<T> disallowInterceptTouchEvent(boolean disallowIntercept) {
     ...
     */
    @Deprecated
    public BannerViewPager2<T> setRoundRect(int radius) {
     ...
     */
    @Deprecated
    public BannerViewPager2<T> setRoundRect(int topLeftRadius, int topRightRadius,
                                            int bottomLeftRadius,
                                            int bottomRightRadius) {
