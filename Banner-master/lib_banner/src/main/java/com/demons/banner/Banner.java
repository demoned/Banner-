...
import com.demons.banner.transformers.BasePageTransformer;
import com.demons.banner.transformers.Transformer;
...
public class Banner extends RelativeLayout implements BannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        mClipChildrenLeftMargin = BannerUtils.dp2px(context, 30);
        mClipChildrenRightMargin = BannerUtils.dp2px(context, 30);
    ...
    private void initView() {
        ...
        if (mIsNumberIndicator) {
            ...
            mNumberIndicatorTv.setId(R.id.banner_pointId);
            ...
            mPointRealContainerLl.setId(R.id.banner_pointId);
        ...
        if (CENTER == mPointPosition) {
            ...
            pointLp.addRule(RelativeLayout.LEFT_OF, R.id.banner_pointId);
        } else if (LEFT == mPointPosition) {
            mPointRealContainerLp.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
            if (mTipTv != null) {
                mTipTv.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
            }
            pointLp.addRule(RelativeLayout.RIGHT_OF, R.id.banner_pointId);
    ...
    public void setData(@NonNull List<?> models, List<String> tips) {
        setData(R.layout.item_image, models, tips);
    }
    ...
    public void setBannerData(@NonNull List<? extends BaseBannerInfo> models) {
        setBannerData(R.layout.item_image, models);
    }
